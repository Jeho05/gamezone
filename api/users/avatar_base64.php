<?php
// api/users/avatar_base64.php
// Upload user avatar (stocké en BASE64 dans MySQL)
...
function optimizeAvatarImage($path, $extension, $maxSize = 400) {
    ...
    $destination = imagecreatetruecolor($newSize, $newSize);
    ...
    imagecopyresampled($destination, $source, 0, 0, $srcX, $srcY, $newSize, $newSize, $srcW, $srcH);
