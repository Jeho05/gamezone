...
-- MySQL schema for GameZone backend - VERSION INFINITYFREE
-- Cette version n'inclut PAS les commandes CREATE DATABASE et USE
-- car InfinityFree ne permet pas de créer des bases via SQL
